...
/**
 * @ORM\Entity(repositoryClass="Fly\PlatformBundle\Entity\TravelingWithRepository")
...
class TravelingWith
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Fly\UserBundle\Entity\Group", mappedBy="travelingWith")
     **/
    private $groups;
